...
|---------|---------|---------------------|
| `historico_atendimento.csv` | CSV | Contextualizar interações anteriores , ou seja , da continuidade ao atedimento de forma mais eficiente |
...
| `transacoes.csv` | CSV | Analisar padrão de gastos do cliente e usar essa informação de forma didatica|
